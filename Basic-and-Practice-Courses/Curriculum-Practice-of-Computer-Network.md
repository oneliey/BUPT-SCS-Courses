...
3. **授课内容**：一次课（3 课时）讲解 DNS 相关
4. **考核方式**：期末验收 + 报告
5. **作业情况**：无作业，AI辅助约使用3000万tokens
6. **成绩情况**：99
7. **心得体会**
   - 收获非常大。要求不超过3人组队，但如果一个人把所有模块都做一遍的话，会彻底深入理解网络编程。
   - 主要由助教验收，助教几乎就是照着验收表格打勾，只要自己做了就能通过。助教十分友善，甚至在验收之前提醒用WSL的同学如何用tcpdump进行抓包。实验报告我是用AI写的，老师基本没深究。
   - 测QPS是加分项，如果QPS足够惊艳，就可以拿到99分。
   - 课程感想在这里 [北邮计算机网络课设：AI编程狂欢后的思考 - 知乎](https://zhuanlan.zhihu.com/p/2050309628966261870)，代码仓库在[这里](https://github.com/AUV888/DNS_Relay)
8. **其他方面**：这个课太爽了，可以用AI Agent辅助，但是要拿高分还是要动脑子的。
