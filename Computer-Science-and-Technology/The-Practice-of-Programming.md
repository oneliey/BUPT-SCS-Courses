...
1. **开课信息**：赵耀（2025 秋）
2. **推荐等级**：强烈推荐
3. **授课内容**：主要讲解程序设计规范，包括风格、记法、测试、性能、改错等等程序设计的编程规范。大部分理念确实比较过时。
4. **考核方式**：四次小作业（接口、排错、测试、性能） + 期末大作业，比例忘了
5. **作业情况**：基于领域特定语言的客服机器人设计与实现，增加了与时俱进的ai意图分析要求。
6. **成绩情况**：90+
7. **心得体会**：比较水的课，课程内容比较无聊，不考勤（特殊时期学校严查除外）也没必要听。小作业只要写报告，大作业可以算得上是编译原理大作业了，不过不限技术栈，python有比较成熟框架(ply)，上面的同学说的yaml这种更糊弄的做法应该也可以，那就更简单。