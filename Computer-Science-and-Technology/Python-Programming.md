...
1. **开课信息**：王智立（2025秋）
2. **推荐等级**：强烈推荐
3. **授课内容**：这个老师第2次教Python，会自己写PPT和程序，每次上课前会发到群里供大家参考（程序也发，纯好）
4. **考核方式**：实验加大作业
5. **作业情况**：大作业是用scrapy写一个爬虫，爬取两个网站的图书数据，然后进行处理，比较简单（每年不一样，但是王哥都会要求爬虫规范，很有道德）
6. **成绩情况**：95+
7. **心得体会**：老师期中之后开始偶尔点名了，期中之前没点名，闭眼选就完了
