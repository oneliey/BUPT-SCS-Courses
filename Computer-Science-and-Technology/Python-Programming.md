...
1. **开课信息**：王智立（2024秋）
2. **推荐等级**：强烈推荐
3. **授课内容**：这个老师第一次教Python，会自己写PPT和程序，每次上课前会发到群里供大家参考
4. **考核方式**：实验加大作业
5. **作业情况**：大作业是用scrapy写一个爬虫，爬取两所学校的就业数据，然后进行处理，比较简单
6. **成绩情况**：95+
7. **心得体会**：老师上课很腼腆，课件和程序是自己手写的这点很好，比用清朝PPT的还是好多了，而且给分相当慷慨，上课从不点名
...
1. **开课信息**：李炜（2025秋）
2. **推荐等级**：一般推荐
3. **授课内容**：Python 基本语法+Python数据分析及数据可视化(Numpy, Pandas, Matplotlib等)+Python网络爬虫
4. **考核方式**：平时OJ + 实验，期末大作业
5. **作业情况**：作业量不大，一周不超过半小时，OJ简单到懒得自己写，实验也是一些很基本的操作，比较好糊弄
6. **成绩情况**：95+
7. **心得体会**：比较水的一门课，相信大家选这门课的时候至少80%的人已经会python了，虽然数据处理、爬虫这些可能有个别方面没接触过，但是课程要求都很基础。老师不考勤，所以课实际上一节都不用来（？）。非常适合只是想混学分的人选，至于为什么不是强烈推荐，主要是因为祖传期末爬虫大作业太恶心了（爬链家），除此之外还是很好的。
